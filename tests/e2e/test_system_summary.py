...
@pytest.mark.skipif(not _HAS_SYSTEM_SUMMARY, reason="optional integration test: local-only docs")
...
@pytest.mark.skipif(not _HAS_ONEPAGER, reason="optional integration test: local-only docs")
...
@pytest.mark.skipif(not (_HAS_SYSTEM_SUMMARY and _HAS_ONEPAGER), reason="optional integration test: local-only docs")
