...
_HAS_REAL_EMBEDDING_MODEL = (
    EmbeddingModel().is_available()
    and not getattr(settings, "ci_mode", False)
)
...
@pytest.mark.skipif(not _HAS_REAL_EMBEDDING_MODEL, reason="external dependency unavailable: sentence-transformers model")
